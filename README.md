...
We also use CMS collider data (publicly available from [http://opendata.web.cern.ch](CERN Open data) ) to learn to predict the invariant mass of the Z boson in a Z &rarr; e+ e- decay. The repository for the exercise with templates and solutions is available [from here](./Problem_set_1).
